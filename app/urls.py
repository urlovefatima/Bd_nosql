...
from .views import get_events, get_events_categories, delete_event, create_event, get_events_gratuits, get_events_payants, get_events_aujourdhui, get_events_semaine, get_events_mois
